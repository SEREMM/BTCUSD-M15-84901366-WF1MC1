...
input int Stop_Loss   = 184; // Stop Loss (pips)
...
static input int Magic_Number = 84901366; // Magic Number
...
void ManageOpen()
  {
   double ind0val1 = iForce(NULL,0,Ind0Param0,MODE_SMA,PRICE_CLOSE,1);
   double ind0val2 = iForce(NULL,0,Ind0Param0,MODE_SMA,PRICE_CLOSE,2);
   double ind0val3 = iForce(NULL,0,Ind0Param0,MODE_SMA,PRICE_CLOSE,3);
...
//+------------------------------------------------------------------+
/*STRATEGY MARKET Premium Data; BTCUSD; M15 */
/*STRATEGY CODE {"properties":{"entryLots":0.01,"tradeDirectionMode":0,"stopLoss":184,"takeProfit":0,"useStopLoss":true,"useTakeProfit":false,"isTrailingStop":false},"openFilters":[{"name":"Force Index","listIndexes":[7,0,0,0,0],"numValues":[17,0,0,0,0,0]},{"name":"Moving Average","listIndexes":[5,0,3,0,0],"numValues":[16,0,0,0,0,0]}],"closeFilters":[{"name":"Force Index","listIndexes":[5,0,0,0,0],"numValues":[8,0,0,0,0,0]}]} */
